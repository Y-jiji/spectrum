...
DEFINE_string(protocol, "Serial", "transaction protocol");
...
DEFINE_bool(aria_read_only, false, "spectrum read only optimization");
DEFINE_bool(aria_reordering, false, "spectrum reordering optimization");
DEFINE_bool(aria_si, false, "spectrum snapshot isolation");
...
DEFINE_int32(sparkle_lock_manager, 0, "# of lock manager in sparkle.");
DEFINE_int32(ariaFB_lock_manager, 1, "# of lock manager in fallback mode.");
DEFINE_int32(commit_threads, 1, "# commit threads.");
DEFINE_int32(scheduled_start_index, 0, "scheduled_start_index.");
DEFINE_int32(scheduled_end_index, 0, "scheduled_end_index.");
DEFINE_bool(synthetic, false, "synthetic workload");
DEFINE_bool(sche_only_hotspots, false, "schedule only hotspot keys");
...
#define SETUP_CONTEXT(context)                                             \
  ...
  context.synthetic = FLAGS_synthetic;                                     \
  context.sche_only_hotspots = FLAGS_synthetic;                            \
