...
DEFINE_int32(keys, 20000, "keys in a partition.");
...
DEFINE_int32(look_ahead, 0, "look ahead works");
DEFINE_int32(cold_record_ratio, 0, "cold_record_ratio");
DEFINE_int32(pre_sched_num, 200, "pre_sched_num");
DEFINE_int32(re_sched_num, 300, "re_sched_num");
...
int main(int argc, char *argv[]) {
  ...
  context.sparkle_lock_manager = FLAGS_sparkle_lock_manager;
  context.ariaFB_lock_manager = FLAGS_ariaFB_lock_manager;
  context.commit_threads = FLAGS_commit_threads;
  context.sche_only_hotspots = FLAGS_sche_only_hotspots;
  context.scheduled_start_index = FLAGS_scheduled_start_index;
  context.scheduled_end_index = FLAGS_scheduled_end_index;
  context.cold_record_ratio = FLAGS_cold_record_ratio;
  context.pre_sched_num = FLAGS_pre_sched_num;
  context.re_sched_num = FLAGS_re_sched_num;
